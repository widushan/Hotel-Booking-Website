...
const Dashboard = () => {
  ...
  return (
    ...
    <div>
        ...
        <Title align='left' font='outfit' title='Dashboard' subTitle='Welcome to your dashboard, where you can easily manage your listings and bookings.' />
        ...
        {/* -- Bookings -- */}
        <h2 className='text-xl text-blue-950/70 font-edium mb-5'>Recent Bookings</h2>
            ...
            <table className='w-full'>
                <thead className='bg-gray-50'>
                    <tr>
                        ...
                        <th className='py-3 px-4 text-gray-800 font-medium text-center max-sm:hidden'>Total Amount</th>
